'''
Use this if you want to convert categorical columns to numeric using OrdinalEncoder, generate synthetic data with TabPFN, 
and then convert back to the original categorical values. This implementation does not explode the number of columns like one-hot encoding would.
This approach allows you to handle categorical data while still leveraging the capabilities of TabPFN for synthetic data generation.
